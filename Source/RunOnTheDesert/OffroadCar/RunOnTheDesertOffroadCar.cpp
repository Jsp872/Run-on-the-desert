...
#include "RunOnTheDesertOffroadCar.h"
#include "RunOnTheDesertOffroadWheelFront.h"
#include "RunOnTheDesertOffroadWheelRear.h"
...
ARunOnTheDesertOffroadCar::ARunOnTheDesertOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URunOnTheDesertOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URunOnTheDesertOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URunOnTheDesertOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URunOnTheDesertOffroadWheelRear::StaticClass();
