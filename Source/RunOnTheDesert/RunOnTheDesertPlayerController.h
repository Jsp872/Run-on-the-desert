...
#include "RunOnTheDesertPlayerController.generated.h"

class UInputMappingContext;
class ARunOnTheDesertPawn;
class URunOnTheDesertUI;
...
class ARunOnTheDesertPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<ARunOnTheDesertPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<ARunOnTheDesertPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<URunOnTheDesertUI> VehicleUIClass;

	/** Pointer to the UI widget */
	UPROPERTY()
	TObjectPtr<URunOnTheDesertUI> VehicleUI;
