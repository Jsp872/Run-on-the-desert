...
#include "RunOnTheDesertSportsCar.h"
#include "RunOnTheDesertSportsWheelFront.h"
#include "RunOnTheDesertSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ARunOnTheDesertSportsCar::ARunOnTheDesertSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URunOnTheDesertSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URunOnTheDesertSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URunOnTheDesertSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URunOnTheDesertSportsWheelRear::StaticClass();
